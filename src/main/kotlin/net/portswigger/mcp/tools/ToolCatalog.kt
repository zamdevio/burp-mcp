...
object ToolCatalog {
    ...
    internal fun builtInEntries(): List<ToolEntry> = listOf(
        ...
        entry("get_repeater_east_sidebar_state", "Read Repeater east inspector rail state"),
        entry("set_repeater_east_sidebar_visible", "Expand or collapse the east inspector rail"),
        entry("select_repeater_east_sidebar_tab", "Select an east rail tab (Notes, Explanations, …)"),
        entry("close_repeater_tab", "Closes one Repeater message tab"),
        entry("close_other_repeater_tabs", "Closes all Repeater tabs except keep_tab_id"),
