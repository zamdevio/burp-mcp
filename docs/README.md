...
User-facing reference for **burp-mcp** (Burp Suite MCP extension). Sprint status and agent rules live under **`maintainer/`**, not here.
...
| [`guides/README.md`](guides/README.md) | Agent client setup (Cursor, Claude, …) |

Root **[README](../README.md)** is the product overview and quick start.
